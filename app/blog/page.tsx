...
import { ArrowLeftIcon, BookOpen, CalendarIcon, ScrollText } from "lucide-react";
                ...
                return (
                  <li key={post.slug}>
                    ...
                    >
                      ...
                      <time
                        dateTime={post.date}
                        className="mt-1 flex shrink-0 items-center gap-1.5 text-xs text-muted-foreground md:mt-0"
                      >
